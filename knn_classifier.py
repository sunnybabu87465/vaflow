...
from sklearn import metrics as ms, preprocessing
import pandas as pd
import numpy as np
...
if __name__ == '__main__':
    ...
    try:
        shutil.rmtree("knn_classifier_result")
    except:
        print('Folder not deleted')
    os.mkdir("knn_classifier_result")
    ...
    disp.plot()
    plt.savefig('knn_classifier_result/KNNClassifierConfusionMatrix.png', bbox_inches='tight')

    plt.clf()
    skplt.metrics.plot_roc(np.asarray(y_test.values, int), predict_prob)
    plt.savefig('knn_classifier_result/KNNClassifierROCurve.png', bbox_inches='tight')
